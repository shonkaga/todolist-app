...
# db functions 
from db import get_tasks, add_task, update_task, get_task, delete_task, init_db, get_completed_tasks, update_task_details, is_same_week, update_task_dates, get_tomorrow_schedule
...
def index():
    ...
    return render_template('index.html', active_tasks=active_tasks, completed_tasks=completed_tasks, next_tasks=next_tasks, form=form, days_dict=days_dict)
